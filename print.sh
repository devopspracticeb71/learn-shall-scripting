...
echo -e "\e[31mHello in GREEN colour\e[0m"
echo -e "\e[31mHello in YELLOW colour\e[0m"
echo -e "\e[31mHello in BLUE colour\e[0m"
echo -e "\e[31mHello in MAGENTA colour\e[0m"
echo -e "\e[31mHello in CYAN colour\e[0m"